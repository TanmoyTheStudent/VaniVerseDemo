...
import TTT1 from './sub-components/TTT1';
import TTT2 from './sub-components/TTT2';
      ...
      <TabContext value={value}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <TabList onChange={handleChange} aria-label="lab API tabs example" centered>
            <Tab label="TTT Solution" value="1"  sx={tabDesign} />
            <Tab label="Use-Cases" value="2"  sx={tabDesign}  />
          </TabList>
        </Box>
        <TabPanel value="1"><TTT1/></TabPanel>
        <TabPanel value="2"><TTT2/></TabPanel>
      </TabContext>
    </Box>
