...
import TTS1 from './sub-components/TTS1';
import TTS2 from './sub-components/TTS2';
      ...
      <TabContext value={value}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <TabList onChange={handleChange} aria-label="lab API tabs example" centered>
            <Tab label="TTS Solution" value="1"  sx={tabDesign} />
            <Tab label="Use-Cases" value="2"  sx={tabDesign}  />
          </TabList>
        </Box>
        <TabPanel value="1"><TTS1/></TabPanel>
        <TabPanel value="2"><TTS2/></TabPanel>
      </TabContext>
    </Box>
